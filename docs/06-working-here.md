...
```bash
swift run LampBoardTests              # 759 cases, instantaneous
swift run LampBoardE2E                # 107 cases, about a minute
...
early `return` added to `expect` once made all 759 cases report success while
