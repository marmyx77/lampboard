...
```bash
swift run LampBoardTests              # 768 cases, instantaneous
swift run LampBoardE2E                # 108 cases, about a minute
...
early `return` added to `expect` once made all 768 cases report success while
