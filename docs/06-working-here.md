...
```bash
swift run LampBoardTests              # 772 cases, instantaneous
swift run LampBoardE2E                # 109 cases, about a minute
...
early `return` added to `expect` once made all 772 cases report success while
...
- **small files**: 200–400 lines typical, 800 the limit; the longest today is 789
