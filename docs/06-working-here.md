...
```bash
swift run LampBoardTests              # 754 cases, instantaneous
swift run LampBoardE2E                # 105 cases, about a minute
...
early `return` added to `expect` once made all 754 cases report success while
